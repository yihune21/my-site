...
const Sidebar: React.FC = () => {
  return (
    <aside className="w-56 border-r hidden md:flex flex-col p-4
                      bg-nemo-sidebar border-nemo-border
                      dark:bg-dark-sidebar dark:border-dark-border">
      <p className="text-[10px] font-bold uppercase mb-4 tracking-widest
          ...
          <li key={to}>
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                ${
                  isActive
                    ? "bg-blue-600 text-white shadow-inner dark:bg-dark-active"
